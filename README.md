.NET Standard / Core 2.0 project to manage groups of long running tasks. Includes a concrete implementation for RabbitMq publishers and consumers; with an optional REST API to control the thread pool.  
